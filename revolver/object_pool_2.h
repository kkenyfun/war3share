...
*check list:
*************************************************************************************/
#ifndef __OBJECT_POOL_2_H
#define __OBJECT_POOL_2_H
...
class ObjectPool_malloc
{
public:
	ObjectPool_malloc(){init();};
	~ObjectPool_malloc(){destroy();};
...
class ObjectMutexPool_malloc
{
public:
	ObjectMutexPool_malloc(){init();};
	~ObjectMutexPool_malloc(){destroy();};
...
private:
	ObjectPool_malloc<T, CAPACITY>	obj_list_;
	BASE_LOCK				lock_;
};
